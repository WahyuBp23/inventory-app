         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="lap_bk.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                 ...
                 <div class="card-body">
                     <div class="col">
                        ...
                        <form method="post" class="form-inline">
                            ...
                            <a href="exportbk.php" target="_blank"><button type="button" class="btn ml-1" style="background-color:#6f42c1; color:white;"><i class="fa-solid fa-file-export" style="padding-right:5px"></i>
                                Export
                            </button></a>
                        </form>
                    </div>

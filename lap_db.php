        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="lap_db.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                    <a href="exportdb.php" target="_blank"><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#myModal" style ="background-color:#6f42c1; color:white;margin-left:230px; margin-right:10px;">
                      <i class="fa-solid fa-file-export" style="padding-right:5px"></i> Export
                    </button></a>
                    </div>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      <?php
                        ...
                        if($mulai!=null || $selesai!=null){
                            $ambilsemuadatabarang = mysqli_query($conn, "SELECT * FROM tb_databarang and tanggal BETWEEN '$mulai' and DATE_ADD('$selesai', INTERVAL 1 DAY) order by idmasuk ASC");
                        } else {
                            $ambilsemuadatabarang = mysqli_query($conn, "SELECT * FROM tb_databarang order by idbarang ASC"); 
                        }
                    } else {
                        $ambilsemuadatabarang = mysqli_query($conn, "SELECT * FROM tb_databarang order by idbarang ASC"); 
                    }

                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <?php
                        $ambilsemuadatajenis = mysqli_query($conn, "SELECT * FROM tb_jenisbarang");
                        $i = 1;
                        while ($jenis = mysqli_fetch_array($ambilsemuadatajenis)){
                          $jenisbarang = $jenis['jenis'];
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <!-- Button Edit -->
                              <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit<?=$idj;?>" style = "margin-right:10px;">
                                Edit
                              </button>
                                  <input type="hidden" name="idbarangygmaudihapus" value="<?=$idj;?>">
                                                    <!-- Button Delete -->
                              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idj;?>">
                                Delete
                                  </button></td>
                        </tr>
                            ...
                            <div class="modal-content">
                              ...
                              <form method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                  <input type="text" name="jenisbarang" value="<?=$jenisbarang; ?>" class="form-control" style="margin-bottom:15px;" required>
                                ...
                                <div class="modal-footer">
                                  <button tpye="submit" class="btn btn-primary" name="editjenisbarang">Submit</button>
                                </div>
                              </form>
                            </div>
                          </div>
                        ...
                        <div class="modal fade" id="delete<?=$idj;?>">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <form method="post">
                                <div class="modal-body">
                                  apakah kamu yakin ingin menghapus <?=$jenisbarang;?> ?
                                  <input type="hidden" name="idj" value="<?=$idj;?>">
                                  <br>
                                  <br>
                                </div>
                                ...
                                <!-- Modal footer -->
                                <div class="modal-footer">
                                  <button tpye="submit" class="btn btn-danger" name="hapusjenis">Hapus</button>
                                </div>
                              </form>
                            </div>
                          </div>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data">
      <div class="modal-body">
        <input type="text" name="jenis" placeholder="Jenis Barang" class="form-control" style="margin-bottom:15px;">
        <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" style="margin-bottom:15px;">
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button tpye="submit" class="btn btn-primary" name="addnewjenis">Submit</button>
      </div>

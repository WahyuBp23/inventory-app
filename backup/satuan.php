              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="card-title"> <i class="fas fa-table mr-1"></i> Tabel Satuan Barang</h3>
                    </div>
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <?php
                        $ambilsemuadatajenis = mysqli_query($conn, "SELECT * FROM tb_satuanbarang");
                        $i = 1;
                            ...
                            <div class="modal-content">
                              ...
                              <form method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                  <input type="text" name="satuanbarang" value="<?=$satuanbarang; ?>" class="form-control" style="margin-bottom:15px;" required>
                                ...
                                <div class="modal-footer">
                                  <button tpye="submit" class="btn btn-primary" name="editsatuanbarang">Submit</button>
                                </div>
                              </form>
                            </div>
                          </div>
                        ...
                        <div class="modal fade" id="delete<?=$ids;?>">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <form method="post">
                                <div class="modal-body">
                                  apakah kamu yakin ingin menghapus <?=$satuanbarang;?> ?
                                  <input type="hidden" name="ids" value="<?=$ids;?>">
                                  <br>
                                  <br>
                                </div>
                                ...
                                <!-- Modal footer -->
                                <div class="modal-footer">
                                  <button tpye="submit" class="btn btn-danger" name="hapussatuan">Hapus</button>
                                </div>
                              </form>
                            </div>
                          </div>
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data">
      <div class="modal-body">
        <input type="text" name="satuan" placeholder="Satuan Barang" class="form-control" style="margin-bottom:15px;">
        <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" style="margin-bottom:15px;">
      </div>

      <!-- Modal footer -->
      <div class="modal-footer">
        <button tpye="submit" class="btn btn-primary" name="addnewsatuan">Submit</button>
      </div>

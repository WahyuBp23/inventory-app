              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-table mr-1"></i> Tabel Stock Barang</h3>
                  </div>
                   <?php
                    ...
                    >
                      ...
                      ?>
                        <tr>
                          ...
                          <td style="border-bottom: 1px solid #dee2e6"><?php echo $stock;?>&nbsp<?php echo $satuanbarang;?></td>
                        </tr>
